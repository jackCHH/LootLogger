...
class ItemsViewController: UITableViewController {
    ...
    @IBAction func toggleFavorite(_ sender: UIButton) {
        itemStore.toggleShowOnlyFavorite()
        tableView.reloadData()
    }
    
    override func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        let action = UIContextualAction(style: .normal, title: "Favorite") { _, _, completionHandler in
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return itemStore.getItem().count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let item = itemStore.getItem()[indexPath.row]
        var isFavorite = ""
        ...
        cell.textLabel?.text = "\(item.name) \(isFavorite)"
